...
def generate_html(
    ...
    fig1.suptitle(f"modeldelta: {model_a} → {model_b}", fontsize=13, y=0.99)
    ...
    if include_diagnostics:
        from modeldelta.report.diagnostics import diagnose, format_diagnosis_html
...
<title>modeldelta: {model_a} → {model_b}</title>
<style>
  :root {{
...
<div class='meta'>Generated by modeldelta v{__import__('modeldelta').__version__}</div>
</body></html>"""
